    ...
    <div className="grid">
      ...
      <div className="card">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
          ...
          <input
            ...
            style={{ width: '320px', padding: '10px', borderRadius: '8px', border: '1px solid #d1d5db' }}
          />
        </div>
      ...
      {editingId !== null && (
        <div className="card">
          ...
          <div className="form-row">
            <input name="Image" placeholder="Đường dẫn ảnh chính" value={formData.Image} onChange={handleInputChange} />
          </div>
          ...
          <div style={{ display: 'flex', gap: '10px', marginTop: '20px' }}>
            <button className="btn" onClick={handleSave}>Cập nhật sản phẩm</button>
